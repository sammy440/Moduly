...
const quickStartSteps = [
    ...
    { step: "4", title: "Open dashboard", code: "moduly-zeta.vercel.app/dashboard", desc: "Report syncs live to the visual dashboard." },
];
...
const configOptions = [
    ...
    { option: "Dashboard Sync", desc: "Auto-pushes report to moduly-zeta.vercel.app with --report flag", scope: "API" },
];
