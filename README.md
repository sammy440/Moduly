...
4. **Experience the app:**
   Navigate in your browser to [http://localhost:3000](http://localhost:3000) to view the Moduly landing page and dashboard.
...
1. Install the cli using `npm i -g moduly` in your terminal.
